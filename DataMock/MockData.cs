...
//        {
//            new Privilege(1, "CanReadResponsible"),  // Позволяет читать назначения проб
//            new Privilege(2, "CanWriteResponsible"),  // Позволяет делать назначения проб
//            new Privilege(3, "CanDeleteResponsible"), // Позволяет удалять назначения проб
//            new Privilege(4, "CanWriteSamples"), // Позволяет изменять данные пробы
//            new Privilege(5, "CanViewSampleReports"), // Позволяет просматривать отчет
//            new Privilege(6, "CanAddUsers"),  // Позволяет добавлять пользователей
//            new Privilege(7, "CanDeleteUsers")  // Позволяет удалять пользователей
//        };
...
//            new User(20, "user5", "Sam", "Baker", "hashed_password_user5", new Role[] { Roles[5] }, 1)
//        };
...
//        public static List<Sample_Responsible> SampleResponsibles = new List<Sample_Responsible>
//        {
...
namespace DataMock
{
    public static class MockData
    {
        public static List<Privilege> Privileges { get; } = new List<Privilege>
        {
            new Privilege(1, "CanReadResponsible"),  // Позволяет читать назначения проб
            new Privilege(2, "CanWriteResponsible"),  // Позволяет делать назначения проб
            new Privilege(3, "CanDeleteResponsible"), // Позволяет удалять назначения проб
        ...
        public static List<Repository> Repositories { get; } = new List<Repository>
        {
            new Repository(1, "KDLFirstRepository", 100, "FirstRepo"),
            new Repository(2, "KDLSecondRepository", 50, "SecondRepo")
        };
        ...
        public static List<Sample_Responsible> SampleResponsibles { get; } = new List<Sample_Responsible>
        {
            new Sample_Responsible(1, 1, 1, DateTime.Now.AddDays(-10), true),
            new Sample_Responsible(2, 2, 3, DateTime.Now.AddDays(-20), false),
            new Sample_Responsible(3, 3, 5, DateTime.Now.AddDays(-15), true),
